...
namespace active_directory_b2c_wpf
{
    ...
    /**
     * These classes pulled from MyRadar's Common library, just for the sake of the example.
     */
    ...
    public class Base62Encoder
    {
        ...
        public string Encode(byte[] bytes)
        {
            ...
            while (true)
            {
                ...
                else // Reached the end with some bits left
                {
                    ...
                    sb.Append(Alphabet[(int)(read[0] >> (int)(8 - length))]);
                    break;
                }
            }
        ...
        public byte[] Decode(string base62)
        {
            // Character count
            var count = 0;
    ...
    internal class BitStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            var bits = (int)(tempPos - this.Position - offset);
